...
function FreelancerIcon() {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" className="h-7 w-7" fill="currentColor">
      <polygon points="0,4 13,5 8.2,15.2" />
      <polygon points="5,0 12.1,3.5 6.4,3.1" />
      <polygon points="17.1,0 20.1,4.3 13.4,4.4" />
      <polygon points="19.8,4 31.5,2.4 20.4,4.8" />
      <polygon points="13.8,5.5 20,5.1 18.4,16.3 13.2,21.2 9.3,17" />
      <polygon points="9.1,19.1 12.5,24.4 6.8,32" />
    </svg>
  );
}
